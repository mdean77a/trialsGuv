...
class TestMainFunction:
    ...
    def test_main_successful_download(self, mock_downloader_class, tmp_path):
...
class TestMainFunctionIntegration:
    ...
    def test_main_with_subject_downloads(self, mock_print, mock_downloader_class, tmp_path):
        """Test main function with successful downloads."""
    ...
    @patch('main.ClinicalTrialsDownloader')
    @patch('builtins.print')
    def test_main_with_investigator_only(self, mock_print, mock_downloader_class, tmp_path):
    ...
    @patch('main.ClinicalTrialsDownloader')
    @patch('builtins.print')
    def test_main_with_no_icf_flag(self, mock_print, mock_downloader_class, tmp_path):
    ...
    @patch('main.ClinicalTrialsDownloader')
    @patch('builtins.print')
    def test_main_with_quiet_flag(self, mock_print, mock_downloader_class, tmp_path):
    ...
    @patch('main.ClinicalTrialsDownloader')
    @patch('builtins.print')
    def test_main_prints_download_summary(self, mock_print, mock_downloader_class, tmp_path):
    ...
    @patch('main.ClinicalTrialsDownloader')
    @patch('builtins.print')
    def test_main_prints_protocol_only_for_no_icf(self, mock_print, mock_downloader_class, tmp_path):
